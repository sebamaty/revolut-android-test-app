...
public final class Constants {
    public final class Currency {
        public final class Acronym {
            public static final String EUROPEAN_UNION = "EUR";
            public static final String AUSTRALIA = "AUD";
            public static final String BULGARIA = "BGN";
            ...
            public static final String CROATIA = "HRK";
            public static final String HUNGARY = "HUF";
            public static final String INDONESIA = "IDR";
            public static final String ISRAEL = "ILS";
            public static final String INDIA = "INR";
            public static final String ICELAND = "ISK";
            ...
            public static final String POLAND = "PLN";
            ...
            public static final String SOUTH_AFRICAN_REPUBLIC = "ZAR";
        }
    }
}
